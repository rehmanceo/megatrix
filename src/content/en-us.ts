...
export const enUs: LandingContent = {
  ...
  hero: {
    ...
    subheadline:
      "Megatrix responds to every lead in minutes, qualifies it, and books the appointment automatically — so the job goes to you, not to whoever called back first.",
  ...
  form: {
    ...
    segmentLabel: "Do you work with residential or commercial customers?",
    segmentResidential: "Residential",
    segmentCommercial: "Commercial / multi-family",
    heatPumpTypeLabel: "What type of heat pumps do you install?",
    heatPumpTypeOptions: ["Air-to-Air", "Air-to-Water", "Both", "Other"],
  ...
  thankYou: {
    ...
    calendarCtaLabel: "Book My Time Slot",
    calendarHeading: "Pick a time that works for you",
    calendarIntro: "20 minutes, on us. Choose any open slot below and it's confirmed instantly — no back-and-forth emails.",
    popupTitle: "You're booked!",
    popupBody: "Your growth assessment is confirmed. We've sent the details to your email — see you then.",
    popupCloseLabel: "Got it",
    backHref: "/us",
